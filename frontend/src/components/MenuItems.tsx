        ...
        return (
          ...
          >
            <div className="relative shrink-0">
              ...
              />
              {!item.isAvailable && (
                <span className="absolute items-center justify-center inset-0 flex rounded font-semibold bg-black/60 text-xs text-white">
                  Not Available
                </span>
              )}
            </div>
              ...
              <div className="flex items-center justify-between">
                ...
                {isSeller && (
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="rounded-lg text-red-500 p-2 hover:bg-red-50"
                    >
                      <BiTrash size={18} />
                    </button>
                  </div>
                ...
                {!isSeller && (
                  <button
                    ...
                    className={`flex rounded-lg p-2 justify-center items-center ${!item.isAvailable || isLoading ? "cursor-not-allowed text-gray-400" : "text-red-500 hover:bg-red-50"}`}
                  >
                    {isLoading ? (
                      <VscLoading size={18} />
                    ) : (
